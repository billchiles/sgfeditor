...
";
    ...
    void MainView_SizeChanged(object sender, WindowSizeChangedEventArgs e) {
        ...
        //if (windowWidth <= magic_snappedview_size) { // ApplicationView.Value == ApplicationViewState.Snapped
        //    this.mainLandscapeView.Visibility = Visibility.Collapsed;
        //    //this.snapViewContent.Visibility = Visibility.Visible;   LUCIAN
        //    this.SetupSnappedViewDisplay();
        //}
        //else {
        //    //if (windowWidth <= 1366) {
        ...
        //    //        // Portrait
        //    //    }
        //    //    else { // ApplicationView.Value == ApplicationViewState.Filled 
        //    //    }
        //    //}
        //    // ApplicationView.Value == ApplicationViewState.FullScreenLandscape
        //    //this.snapViewContent.Visibility = Visibility.Collapsed;  LUCIAN
        //    this.mainLandscapeView.Visibility = Visibility.Visible;
        //}
    }
    ...
    private async void mainWin_keydown(object sender, KeyRoutedEventArgs e)
    {
        ...
        // Move branch down
                 ...
                 this.commentBox.FocusState != FocusState.Pointer)
        {  // Covers clicking on it
    ...
    private async void gameTree_mousedown(object sender, PointerRoutedEventArgs e)
    {
        ...
        if (this.Game.CurrentMove != null)
        { // Same as checking game state is not NotStarted.
            this.Game.GotoStart();
            MainWindowAux.RestoreAdornments(this.stonesGrid, this.Game.SetupAdornments);
        }
        else
    ...
    private async Task DeleteCommentLine(int num)
    {
        ...
        for (int i = 1; i < num; i++)
        {
            ...
            {
                if (i == num - 1)
                { // Found num lines, last one does not end in newline sequence
                    tmp = s.Length;
                }
                else
                {
    ...
    private void UpdateCurrentComment(string s)
    {
        ...
        if (old != "")
        { // Clipboard throws bogus null deref exception if the string is empty.
...
internal static class MainWindowAux
{
    ...
    ////
    //// ----------- STUBS CREATED TO GET BUILD TO WORK ---------------  DELETE AS PASTE IN REAL CODE
    ////



    //private void mainWin_keydown(object sender, KeyRoutedEventArgs e)
    //    {
    ...
    //    private void saveButton_left_down(object sender, RoutedEventArgs e)
    //    {
    ...
    //    private void branchComboSelectionChanged(object sender, SelectionChangedEventArgs e)
    //    {
    ...
    //    private void homeButtonLeftDown(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void prevButtonLeftDown(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void nextButtonLeftDown(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void endButtonLeftDown(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void StonesPointerPressed(object sender, PointerRoutedEventArgs e)
    //    {
    ...
    //    private void AppBarGotoGame(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void newButton_left_down(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void openButton_left_down(object sender, RoutedEventArgs e)
    //    {
    ...
    //    private void AppBarSaveAsClick(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void AppBarSaveFlippedClick(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void AppBarMoveUpClick(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void AppBarMoveDownClick(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void AppBarCutClick(object sender, RoutedEventArgs e)
    //    {

    //    }

    //    private void AppBarPasteClick(object sender, RoutedEventArgs e)
    //    {
