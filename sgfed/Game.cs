...
namespace SgfEd {
    ...
    public class Game {
        ...
        public Move MakeMove (int row, int col) {
            ...
            this.mainWin.prevButton.IsEnabled = true;
            this.mainWin.homeButton.IsEnabled = true;
            if (move.Next == null) {
                // Made a move or branch that is at end of line of play.
                this.mainWin.nextButton.IsEnabled = false;
                this.mainWin.endButton.IsEnabled = false;
            }
            else {
                // Made a move that is already the next move in some branch,
                // and it has a next move.
                this.mainWin.nextButton.IsEnabled = true;
                this.mainWin.endButton.IsEnabled = true;
            }
        ...
        public Move UnwindMove () {
            ...
            if (previous == null) {
                this.mainWin.prevButton.IsEnabled = false;
                this.mainWin.homeButton.IsEnabled = false;
            }
            this.mainWin.nextButton.IsEnabled = true;
            this.mainWin.endButton.IsEnabled = true;
            if (previous == null)
        ...
        public Move ReplayMove () {
            ...
            //    this._main_ui.MainWindow.FindName("nextButton").IsEnabled = False
            //    this._main_ui.MainWindow.FindName("endButton").IsEnabled = False
            //this._main_ui.MainWindow.FindName("prevButton").IsEnabled = True
            this.mainWin.prevButton.IsEnabled = true;
            this.mainWin.homeButton.IsEnabled = true;
            this.mainWin.UpdateBranchCombo(this.CurrentMove.Branches, this.CurrentMove.Next);
            this.mainWin.commentBox.Text = this.CurrentMove.Comments;
        ...
        public void GotoLastMove () {
            ...
            this.mainWin.prevButton.IsEnabled = true;
            this.mainWin.homeButton.IsEnabled = true;
            this.mainWin.nextButton.IsEnabled = next != null;
            this.mainWin.endButton.IsEnabled = next != null;
        ...
        private void SaveAndUpdateComments(Move origin, Move dest) {
            ...
            if (dest != null)
                this.mainWin.commentBox.Text = dest.Comments;
            else
                this.mainWin.commentBox.Text = this.Comments;
        }
        ...
        private void SaveComment(Move move = null) {
            var cur_comment = this.mainWin.commentBox.Text;
            if (move != null) {
        ...
        public void CutMove() {
            ...
            if (prev_move == null) {
                this.mainWin.nextButton.IsEnabled = this.FirstMove != null;
                this.mainWin.endButton.IsEnabled = this.FirstMove != null;
                this.mainWin.UpdateBranchCombo(this.Branches, this.FirstMove);
            }
            else {
                this.mainWin.nextButton.IsEnabled = prev_move.Next != null;
                this.mainWin.endButton.IsEnabled = prev_move.Next != null;
